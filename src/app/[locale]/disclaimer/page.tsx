        ...
        <div className="container mx-auto max-w-4xl py-16 px-4 space-y-8 text-foreground">
            ...
            <div className="p-6 bg-destructive/10 border-l-4 border-destructive rounded-r-md mt-8">
                ...
                <p className="text-foreground">
                    CareSanchaar is a care-coordination platform designed to support frontline health workers and public health facilities. It is <strong>not a substitute for qualified healthcare professionals, professional medical assessment, or emergency services</strong>.
                </p>
            ...
            <p className="text-lg leading-relaxed text-muted-foreground mt-8">
                Any triage guidance or risk assessments provided by this platform are protocol-guided tools intended to aid coordination and prioritize care. They do not constitute an autonomous symptom assessment or treatment plan. All clinical decisions remain the sole responsibility of the attending Medical Officer or healthcare provider.
            </p>
        </div>
    );
}
